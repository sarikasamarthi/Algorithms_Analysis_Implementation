//PROGRAM TO IMPLEMENT HUFFMAN ENCODING USING VARIABLE LENGTH METHOD.WHERE THE USER ENTER A STRING ,BASED ON THE STRING THE PROGRAM CALCULATES THE FREQUENCY AND GENERATES THE CODE FOR EACH CHRACTER AND THE FREQUENCY FOR EACH CHARACTER.  
